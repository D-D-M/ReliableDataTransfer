...
void print_packet_info_server(const struct gbnpacket *pac, sender_t stype)
{
...
void print_packet_info_client(const struct gbnpacket *pac, sender_t stype)
{
    // UNCOMMENT this for full packet info
    /*
    printf("==========================================\n");
...
int p_header_size()
{
    return sizeof(struct gbnpacket) - PACKETSIZE; // Minus the 512 bytes of data
}

int p_size()
{
    return sizeof(struct gbnpacket);
}
